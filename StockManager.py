...
if "inventory" not in st.session_state:
    ...
    inventory_df = update_inventory_data(inventory_df)

    st.session_state.inventory = inventory_df


# session_state에 저장된 DataFrame 불러오기
...
#     st.write(f"등록된 상품: **{len(df)}개**")

#     if st.button("🔄 초기 데이터로 되돌리기", use_container_width=True):
